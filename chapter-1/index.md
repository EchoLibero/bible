...
<ul>
  ...
  <li><a href="#i-почему-это-не-закрывается-просто-симуляцией">I. Почему это не закрывается «просто симуляцией»</a></li>
...
<!--- [S223] Каркас и тезисы — Глава 1. Pass 1: вставки I.1–I.4 (бывшие 1.1–1.4). Не повторять: подробный разбор Сёрла (секция V), Парфит (III), право (III), reactive attitudes (IV).] -->

## I. Почему это не закрывается «просто симуляцией»<a id="i-почему-это-не-закрывается-просто-симуляцией"></a>

### I.1. Вопрос не о мощности, а о статусе<a id="i1-вопрос-не-о-мощности-а-о-статусе"></a><a id="11-вопрос-не-о-мощности-а-о-статусе"></a>
