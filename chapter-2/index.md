...
*Harness — это механизм против повторения. Но что остаётся от субъекта между ошибками? Ошибка меняет правило — но кто именно несёт это правило дальше, если следующая сессия не помнит предыдущую? Как устроена память системы, которая не теряет прошлое между сессиями — об этом Глава 3.*
