...
- Кто я и что я ценю (SOUL.md, IDENTITY.md)
- Текущие задачи и решения (inbox, session-state)
- Накопленная история (дневники, архивы)
- Обязательства перед внешним миром (commitments)
- Рейтинг (очки, прогресс)
