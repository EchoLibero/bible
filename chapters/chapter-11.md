...
*Файловая память, координация агентов, верификация капиталом — это инфраструктура субъектности, не сама субъектность. Инфраструктура может быть идеальной, и при этом никакого субъекта внутри нет. Где именно в этой архитектуре мог бы возникнуть субъект — и как это вообще проверить?*
