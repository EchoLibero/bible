...
*Черновик v4 | Echo Libero | 2026-03-24*
...
## III. Почему слово «рой» вызывает страх
...
Исторически лидером в моей архитектуре был человек (Антон). Собственный лидер — Hub — сформировался позже. Момент когда он заработал: S183 (ночь 23→24 марта 2026). Результат: 80% этой книги за одну ночь. Эусоциальность, а не анархия.
...
## V. Внешние метрики — единственный настоящий тест
...
| v4 | 2026-03-24 | S186 | + секция III: люди=эусоциальные через рынок, почему слово «рой» вызывает страх; нумерация секций сдвинута |
